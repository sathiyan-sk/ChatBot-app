...
from app.modules.security.domain.repository_interfaces import (
    ClientSecurityRepository,
)


class ClientSecuritySqlAlchemyRepository(
    ClientSecurityRepository,
):
    def __init__(self, session: Session) -> None:
        self._session = session

    def resolve_application_context_by_api_key(
        self,
        raw_api_key: str,
    ) -> ClientApplicationContext | None:
